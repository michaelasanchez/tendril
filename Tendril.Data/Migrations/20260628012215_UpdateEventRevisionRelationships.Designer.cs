...
namespace Tendril.Data.Migrations
{
    ...
    [Migration("20260628012215_UpdateEventRevisionRelationships")]
    partial class UpdateEventRevisionRelationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScheduledTaskScraperDefinition", b =>
                {
                    b.Property<Guid>("ScheduledTasksId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ScraperDefinitionsId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ScheduledTasksId", "ScraperDefinitionsId");

                    b.HasIndex("ScraperDefinitionsId");

                    b.ToTable("ScheduledTaskScrapers", (string)null);
                });
            ...
            modelBuilder.Entity("Tendril.Core.Domain.Entities.ScheduledTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset?>("LastRunCompletedAtUtc")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("LastRunStartedAtUtc")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("Tendril.Core.Domain.Entities.ScheduledTaskRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tendril.Core.Domain.Entities.ScraperAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ScraperAction", (string)null);
                });
            ...
            modelBuilder.Entity("Tendril.Core.Domain.Entities.ScraperAttemptHistory", b =>
                {
                    ...
                    b.Property<Guid?>("ScheduledTaskRunId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tendril.Core.Domain.Entities.ScraperDefinition", b =>
                {
                    ...
                    b.Property<bool>("HasSuggestions")
                        .HasColumnType("bit");

                    b.Property<bool>("IsEventFeed")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ScheduledTaskScraperDefinition", b =>
                {
                    b.HasOne("Tendril.Core.Domain.Entities.ScheduledTask", null)
                        .WithMany()
                        .HasForeignKey("ScheduledTasksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tendril.Core.Domain.Entities.ScraperDefinition", null)
                        .WithMany()
                        .HasForeignKey("ScraperDefinitionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Tendril.Core.Domain.Entities.EventRevision", b =>
                {
                    ...
                    b.HasOne("Tendril.Core.Domain.Entities.Event", "RelatedEvent")
                        .WithMany()
            ...
            modelBuilder.Entity("Tendril.Core.Domain.Entities.ScheduledTaskRun", b =>
                {
                    b.HasOne("Tendril.Core.Domain.Entities.ScheduledTask", "ScheduledTask")
                        .WithMany("Runs")
            ...
            modelBuilder.Entity("Tendril.Core.Domain.Entities.ScraperAttemptHistory", b =>
                {
                    b.HasOne("Tendril.Core.Domain.Entities.ScheduledTaskRun", "ScheduledTaskRun")
                        .WithMany("AttemptHistories")
                        .HasForeignKey("ScheduledTaskRunId");
